export default function RightPanel() {
  return (
    <div className="w-full h-full flex flex-col bg-[#161b33]/40 p-4 rounded-sm gap-8">
      <div className="w-full h-10 text-xl text-blue-300">Available</div>
      <div className="w-full flex flex-col gap-2">
        <h1>Skills</h1>
        <div className="grid grid-cols-5 gap-1">
          <div className="w-10 h-10 rounded-lg bg-[#161b33] flex items-center justify-center">
            <img src="react.svg" width={30} height={30} />
          </div>
          <div className="w-10 h-10 rounded-lg bg-[#161b33] flex items-center justify-center">
            <img src="tailwind.svg" width={30} height={30} />
          </div>
          <div className="w-10 h-10 rounded-lg bg-[#161b33] flex items-center justify-center">
            <svg
              width="30px"
